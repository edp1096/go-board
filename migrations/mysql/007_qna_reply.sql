-- migrations/mysql/007_qna_reply.sql
-- +goose Up
-- +goose StatementBegin
-- 답변 테이블에 parent_id 추가
ALTER TABLE qna_answers ADD COLUMN parent_id INT DEFAULT NULL;
-- +goose StatementEnd
...
-- +goose StatementBegin
-- 외래 키 제약 제거
ALTER TABLE qna_answers DROP FOREIGN KEY fk_qna_answers_parent_id;
-- +goose StatementEnd

-- +goose StatementBegin
-- 인덱스 제거
DROP INDEX idx_qna_answers_parent_id ON qna_answers;
-- +goose StatementEnd
